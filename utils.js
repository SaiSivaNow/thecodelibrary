...
const query_params = {
    client_id: '529721866333-t9jf7gqtvd0ehnserkugmq8c8475lohu.apps.googleusercontent.com',
    redirect_uri: `https://thecodelibrary.in/auth/redirect`,
};

const get_access_token = async auth_code => {
    const access_token_params = {
        ...query_params,
        client_secret: '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',
        code: auth_code,
